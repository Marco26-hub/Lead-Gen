...
const FONTS = "https://fonts.googleapis.com/css2?family=Anton&family=DM+Sans:wght@400;500;600;700&display=swap";
...
/** Carne-Montagna — dark dramatic steakhouse / mountain grill. Anton, ember+gold. */
export function CarneMontagna({ model, rating, reviewCount, photos, openingHours }: DemoProps) {
        ...
        <div className={styles.content}>
          ...
          <section className={styles.hero} id="top">
            {heroPhoto ? (
              ...
              <img className={styles.heroMedia} src={heroPhoto} alt={`${name} — la griglia`} />
          ...
          <section className={styles.block} id="brace">
            <div className={styles.wrap}>
              <div className={styles.head}><span className={styles.eyebrow}>La brace</span><h2>Fuoco, legna e carni scelte</h2></div>
          ...
          {menu && (
            <section className={`${styles.block} ${styles.menu}`} id="menu">
              <div className={styles.wrap}>
                <div className={styles.head}><span className={styles.eyebrow}>La carta</span><h2>Il nostro menù</h2>{menu.note && <p>{menu.note}</p>}</div>
          ...
          {gallery.length > 0 && (
            <section className={styles.block} id="galleria">
              <div className={styles.wrap}>
                <div className={styles.head}><span className={styles.eyebrow}>Galleria</span><h2>Dalla nostra cucina</h2></div>
            ...
            <div className={`${styles.wrap} ${styles.about}`}>
              ...
              {aboutPhoto && (
                <div className={styles.aboutImg}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={aboutPhoto} alt={`${name} — sala`} loading="lazy" />
                </div>
              )}
            </div>
          </section>
